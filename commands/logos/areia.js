...
export const description = 'Logo estilo areia';
export const uso = '/areia texto';
export const cooldown = 5;
export default async function areia(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}areia Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
