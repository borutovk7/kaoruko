...
export const description = 'Logo estilo neon2';
export const uso = '/neon2 texto';
export const cooldown = 5;
export default async function neon2(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}neon2 Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
