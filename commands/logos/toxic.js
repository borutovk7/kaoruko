...
export const description = 'Logo estilo toxic';
export const uso = '/toxic texto';
export const cooldown = 5;
export default async function toxic(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}toxic Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
