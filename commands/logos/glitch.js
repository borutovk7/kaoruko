...
export const description = 'Logo estilo glitch';
export const uso = '/glitch texto';
export const cooldown = 5;
export default async function glitch(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}glitch Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
