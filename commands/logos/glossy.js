...
export const description = 'Logo estilo glossy';
export const uso = '/glossy texto';
export const cooldown = 5;
export default async function glossy(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}glossy Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
