...
export const description = 'Logo estilo neon';
export const uso = '/neon texto';
export const cooldown = 5;
export default async function neon(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}neon Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
