...
export const description = 'Logo estilo lapis';
export const uso = '/lapis texto';
export const cooldown = 5;
export default async function lapis(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}lapis Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
