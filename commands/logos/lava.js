...
export const description = 'Logo estilo lava';
export const uso = '/lava texto';
export const cooldown = 5;
export default async function lava(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}lava Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
