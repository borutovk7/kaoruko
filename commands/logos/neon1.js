...
export const description = 'Logo estilo neon1';
export const uso = '/neon1 texto';
export const cooldown = 5;
export default async function neon1(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}neon1 Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
