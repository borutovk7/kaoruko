...
export const description = 'Logo estilo rainbow';
export const uso = '/rainbow texto';
export const cooldown = 5;
export default async function rainbow(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}rainbow Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
