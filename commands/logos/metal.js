...
export const description = 'Logo estilo metal';
export const uso = '/metal texto';
export const cooldown = 5;
export default async function metal(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}metal Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
