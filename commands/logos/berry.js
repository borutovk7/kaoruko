...
export const description = 'Logo estilo berry';
export const uso = '/berry texto';
export const cooldown = 5;
export default async function berry(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}berry Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
