...
export const description = 'Logo estilo fire';
export const uso = '/fire texto';
export const cooldown = 5;
export default async function fire(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}fire Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
