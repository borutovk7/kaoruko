...
export const description = 'Logo estilo jeans';
export const uso = '/jeans texto';
export const cooldown = 5;
export default async function jeans(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}jeans Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
