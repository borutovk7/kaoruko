...
export const description = 'Logo estilo cattxt';
export const uso = '/cattxt texto';
export const cooldown = 5;
export default async function cattxt(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}cattxt Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
