...
export const description = 'Logo estilo neon3d';
export const uso = '/neon3d texto';
export const cooldown = 5;
export default async function neon3d(ctx) {
  if (!ctx.q) {
    await ctx.uso(`${ctx.prefix}neon3d Kaoruko`, 'Insira um texto pra eu fazer sua logo!');
    return;
  }
