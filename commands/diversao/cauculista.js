...
export const description = 'Mede o quanto alguem e cauculista';
export const uso = '/cauculista @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function cauculista(ctx) {
