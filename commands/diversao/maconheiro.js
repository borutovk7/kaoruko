...
export const description = 'Mede o quanto alguem e maconheiro';
export const uso = '/maconheiro @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function maconheiro(ctx) {
