...
export const description = 'Mede o quanto alguem e riquinha';
export const uso = '/riquinha @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function riquinha(ctx) {
