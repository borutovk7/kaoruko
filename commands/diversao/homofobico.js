...
export const description = 'Mede o quanto alguem e homofobico';
export const uso = '/homofobico @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function homofobico(ctx) {
