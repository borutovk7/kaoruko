...
export const description = 'Mede o quanto alguem e maconheira';
export const uso = '/maconheira @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function maconheira(ctx) {
