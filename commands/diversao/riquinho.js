...
export const description = 'Mede o quanto alguem e riquinho';
export const uso = '/riquinho @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function riquinho(ctx) {
