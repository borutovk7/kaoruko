...
export const description = 'Mede o quanto alguem e punheteiro';
export const uso = '/punheteiro @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function punheteiro(ctx) {
