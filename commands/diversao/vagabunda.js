...
export const description = 'Mede o quanto alguem e vagabunda';
export const uso = '/vagabunda @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function vagabunda(ctx) {
