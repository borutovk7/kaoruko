...
export const description = 'Mede o quanto alguem e vagabundo';
export const uso = '/vagabundo @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function vagabundo(ctx) {
