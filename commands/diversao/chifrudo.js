...
export const description = 'Mede o quanto alguem e chifrudo';
export const uso = '/chifrudo @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function chifrudo(ctx) {
