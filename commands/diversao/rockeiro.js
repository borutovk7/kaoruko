...
export const description = 'Mede o quanto alguem e rockeiro';
export const uso = '/rockeiro @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function rockeiro(ctx) {
