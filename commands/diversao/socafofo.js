...
export const description = 'Mede o quanto alguem e socafofo';
export const uso = '/socafofo @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function socafofo(ctx) {
