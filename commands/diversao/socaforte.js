...
export const description = 'Mede o quanto alguem e socaforte';
export const uso = '/socaforte @fulano';
export const cooldown = 2;
export const oculto = true;
export default async function socaforte(ctx) {
