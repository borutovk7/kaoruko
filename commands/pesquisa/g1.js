...
export const description = 'Noticias do G1/Globo';
export const aliases = ['globo'];
export const uso = '/g1';
export const cooldown = 5;
export default async function cmdg1(ctx) {
  const carregando = await ctx.carregando(' Buscando...');
  try {
    const bruto = await pesquisa.noticiasGlobo();
    ...
    const linhas = ['<b>NOTICIAS DO G1/GLOBO</b>', ''];
